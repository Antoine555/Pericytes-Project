function [u, erriter, i, timet] = CMF3D_Cut2
%
...
%addpath ('C:\Users\Anto\Documents\Oxford Uni\4th year\4YP\Capillaries work');
%load test_image;
addpath('C:\Users\Anto\Documents\Oxford Uni\4th year\4YP')
load M
nfi_data=M(1:100,1:100,1:30);
%nfi_data = imOut;
ur = double(nfi_data)/255;
