...
% V10 uses a patchy way of reinitialising all the variables so that no
% error appears
...
for peri=12:1:14      %size(perixyzM,1) % analyse one pericyte at a time
    
    %Patchy way of clearing all variables except a few. This could be opt
    clearvars -except excluded Vref00 V_red Stack_vessels Excel_Data ...
        Excel_Data2 Excel_Data3 perixyzM healthM peri window slice2D_size ...
        step_size nber_slices_max File aspect_ratio
